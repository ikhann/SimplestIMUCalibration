...
The program reads the data stream from the serial port and provides visualization of the measurements and the zero-offset calibration calculation.
...
Noisy measurements of three-axis magnetometer:
